...
""""This kernal define functions for F1 optimization.This are the functions 
to be called ,if we want to do F1 optimization."""
class F1Optimizer():
    def __init__(self):
        pass
...
if __name__ == '__main__':
    print_best_prediction(A)   #Get A the output from GBMs and pass as the argument
    benchmark()
